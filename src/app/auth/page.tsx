    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#667eea] to-[#764ba2]">
      <div className="bg-white rounded-2xl p-8 w-full max-w-sm shadow-xl">
        <div className="text-center mb-6">
          <h1 className="text-2xl font-bold">📘 学习小队</h1>
          <p className="text-sm text-gray-500 mt-1">登录后开始学习</p>
        </div>
        <div className="space-y-3">
          <Button className="w-full bg-white border text-gray-700 hover:bg-gray-50" variant="outline">
        ...
        <div className="mt-6 text-center">
          <Link href="/" className="text-sm text-[#667eea] hover:underline">
            跳过登录，直接试用 →
          </Link>
        </div>
      </div>
